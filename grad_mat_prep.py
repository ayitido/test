...
system_name = 'T-graphene'
openmx_executable_path = "/home/gengbin_32346034_stl_155/softwares/MachineLearning/HamGNN/openmx_postprocess/"
work_path = "./"
graph_data_dir = "./perturb/graph_data.npz"
mat_info_sc_dir = "./perturb/mat_info_rc.npy"
unitcell_dir = "./POSCAR.vasp"
H_pred_result_dir = "/home/gengbin_32346034_stl_155/ML/temp/ham/version_0/prediction_hamiltonian.npy"
delta_r = 0.01 # ang
...
if read_dSon:
    ...
    for iatom, each in enumerate(uc_atoms_dict['chemical_symbols']):
        if each not in element_unique:
            ...
            #dSon_atoms_dict['positions'] = np.array([[1.7233617,   0.6867256,   1.0000000],[0.6867256,   1.7233617,   1.0000000],[2.7599979   ,1.7233617  , 1.0000000],[1.7233617,   2.7599979,   1.0000000]])
